...
export const Lesson2Sidebar: React.FC = () => {
    return (
            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <ul className="space-y-1 mt-2 max-h-60 overflow-y-auto custom-scrollbar pr-1">
                        ...
                        <li className="flex justify-between items-center text-gray-700"><span>índio/homem</span> <span className="font-mono text-blue-700 font-bold bg-blue-50 px-1 rounded">abá</span></li>
                        ...
                        <li className="flex justify-between items-center text-gray-700"><span>rio/água</span> <span className="font-mono text-blue-700 font-bold bg-blue-50 px-1 rounded">'y</span></li>
