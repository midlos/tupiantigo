...
interface SectionConjugationL1Props {
    onNext: () => void;
}
...
const ConjugationCard: React.FC<{
    ...
    return (
        <div 
            className={`rounded-xl p-4 transition-all border-2 border-transparent ${colorClasses}`}
        >
...
export const SectionConjugationL1: React.FC<SectionConjugationL1Props> = ({ onNext }) => {
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8 items-start">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <ConjugationCard 
                        ...
                        colorClasses="bg-gradient-to-r from-blue-50 to-blue-100 text-blue-800"
                    >
                    ...
                    <ConjugationCard 
                        ...
                        colorClasses="bg-gradient-to-r from-purple-50 to-purple-100 text-purple-800"
                    >
                    ...
                    <ConjugationCard 
                        ...
                        colorClasses="bg-gradient-to-r from-green-50 to-green-100 text-green-800"
                    >
                    ...
                    <ConjugationCard 
                        icon="👥👤" 
                        title="ASÉ (impessoal)" 
                        colorClasses="bg-gradient-to-r from-indigo-50 to-indigo-100 text-indigo-800"
                    >
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <ConjugationCard 
                        ...
                        colorClasses="bg-gradient-to-r from-red-50 to-red-100 text-red-800"
                    >
                    ...
                    <ConjugationCard 
                        ...
                        colorClasses="bg-gradient-to-r from-teal-50 to-teal-100 text-teal-800"
                    >
                    ...
                    <ConjugationCard 
                        ...
                        colorClasses="bg-gradient-to-r from-orange-50 to-orange-100 text-orange-800"
                    >
                    ...
                    <ConjugationCard 
                        ...
                        colorClasses="bg-gradient-to-r from-pink-50 to-pink-100 text-pink-800"
                    >
                        <p className="text-xl"><strong className="text-green-700">a'e</strong> <strong className="text-amber-600">o-</strong><span className="text-black">nhe'eng</span></p>
