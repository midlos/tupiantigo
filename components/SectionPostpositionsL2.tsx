...
interface SectionPostpositionsL2Props {
    onNext: () => void;
}

export const SectionPostpositionsL2: React.FC<SectionPostpositionsL2Props> = ({ onNext }) => {
    return (
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6 slide-in">
            ...
            {/* PE */}
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 mb-8 border-l-4 border-green-500 shadow-sm">
                <div className="flex flex-col md:flex-row md:items-center gap-3 mb-4">
                    <span className="bg-green-600 text-white font-bold text-xl px-4 py-2 rounded-lg shadow self-start md:self-center">-PE</span>
            ...
            {/* SUPE */}
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 mb-8 border-l-4 border-blue-500 shadow-sm">
                <div className="flex flex-col md:flex-row md:items-center gap-3 mb-4">
                    <span className="bg-blue-600 text-white font-bold text-xl px-4 py-2 rounded-lg shadow self-start md:self-center">SUPÉ</span>
                    <span className="text-lg font-semibold text-blue-800">= para (pessoas ou coisas - dativo). Tônica.</span>
                </div>
                <p className="text-sm text-blue-600 mb-3 italic font-medium bg-blue-100 inline-block px-2 py-1 rounded">Só usada para a 3ª pessoa.</p>
                <div className="grid md:grid-cols-2 gap-4">
            ...
            {/* SUI */}
            <div className="bg-gradient-to-r from-red-50 to-rose-50 rounded-xl p-6 mb-8 border-l-4 border-red-500 shadow-sm">
                <div className="flex flex-col md:flex-row md:items-center gap-3 mb-4">
                    <span className="bg-red-500 text-white font-bold text-xl px-4 py-2 rounded-lg shadow self-start md:self-center">SUÍ</span>
            ...
            {/* PUPE */}
            <div className="bg-gradient-to-r from-purple-50 to-fuchsia-50 rounded-xl p-6 mb-8 border-l-4 border-purple-500 shadow-sm">
                <div className="flex flex-col md:flex-row md:items-center gap-3 mb-4">
                    <span className="bg-purple-600 text-white font-bold text-xl px-4 py-2 rounded-lg shadow self-start md:self-center">PUPÉ</span>
